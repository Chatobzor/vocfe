...
<tr>
  ...
  <select name="type">
    ...
    <option value="SPEED"<? if ($type=="SPEED") {echo ' selected="selected"';}?>>самых быстрых</option>
  </select>
  </td>
  <td>
  <select name="when">
    <option value="TODAY"<? if ($when=="TODAY") {echo ' selected="selected"';}?>>сегодня</option>
    <option value="YESTERDAY"<? if ($when=="YESTERDAY") {echo ' selected="selected"';}?>>вчера</option>
    <option value="WEEK"<? if ($when=="WEEK") {echo ' selected="selected"';}?>>за неделю</option>
    <option value="MONTH"<? if ($when=="MONTH") {echo ' selected="selected"';}?>>за месяц</option>
    <option value="ALWAYS"<? if ($when=="ALWAYS") {echo ' selected="selected"';}?>>с последнего обнуления<?=$reset;?></option>
  </select>
  </td>
