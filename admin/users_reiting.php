...
<body bgcolor="E5E5E5" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" link=#000000 alink=#000000
        vlink=#000000>
<?php
if ($dtop >= 30) {
...
if (count($reiting_rez) < REITING_MAXHITS) {
    $MaxHits = count($reiting_rez);
}
?>
