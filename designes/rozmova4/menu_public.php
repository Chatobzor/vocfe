...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <tr align="center">
        <td width="143" height="24" background="<?= $current_design ?>grunge/grunge_09.gif" align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<nobr>
                <b><font color=white><?= $rooms[$cu_array[USER_ROOM]]["title"] ?></font></a></b></nobr>&nbsp;&nbsp;
        </td>
        <td width="23" height="24"><a href="#" onClick="parent.clear_pub()"><img
                        src="<?= $current_design ?>grunge/grunge_10.gif" width="23" height="24" border="0"
                        alt="<?= $w_roz_clear_pub_all ?>"></a></td>
        <td width="20" height="24"><a href="#" onClick="click_pause()"><img border="0" name="pause_img" id="pause_img"
                        alt="<?= $w_roz_pause_tip ?>" src="<?= $current_design ?>grunge/grunge_11.gif" width="20"
                        height="24"></a></td>
        <td width="20" height="24"><a href="#" onClick="click_filter()"><img border="0" name="filter_img"
                        id="filter_img" alt="<?= $w_filter_tip ?>" src="<?= $current_design ?>grunge/grunge_12.gif"
                        width="20" height="24"></a></td>
        <td height="24">&nbsp;</td>
