...
$translit_table_general_ua = array(
    "a" => "а",
    "b" => "б",
    "d" => "д",
    "e" => "е",
...
$translit_table_polysymbolic_ua = array(
    "sch" => "щ",
    "gh" => "зг",
    "ie" => "є",
    "kh" => "х",
    ...
    function translit_ua($msg)
    {
        ...
        for ($i = 0; $i < count($word_arr); $i++) {
            ...
            if (strlen($word_arr[$i]) > 1) {
                ...
                if (strlen($word_arr[$i]) > MAX_START_VAL_UA) {
                    $b = substr($word_arr[$i], MAX_START_VAL_UA);
                } else {
                    $b = "";
                }
